...
export default function Index() {
  return (
    <View className="flex-1 p-5 gap-10">
      ...
      <View className="bg-yellow-400 flex-row w-full h-60 rounded-lg items-center justify-around">
        <Image source={require('../assets/images/roupa.png')} className="max-w-28 max-h-36"></Image>
        <View className="flex-col items-center">
          <Text className="text-white text-2xl font-light">Liquida Verão 2025</Text>
          <Text className="text-white text-2xl font-bold">Roupas com até 60%</Text>
          <Text className="text-white text-2xl font-bold">de Desconto</Text>
        </View>
      </View>
      ...
      <View className="flex-col gap-3">
        ...
        <View className="flex-row w-full gap-5">
          <Image source={require('../assets/images/camisa.png')} className="max-w-12 max-h-12 bg-white rounded-md p-2"></Image>
          <Image source={require('../assets/images/tenis.png')} className="max-w-12 max-h-12 bg-white rounded-md p-2"></Image>
          <Image source={require('../assets/images/bolsa.png')} className="max-w-12 max-h-12 bg-white rounded-md p-2"></Image>
          <Image source={require('../assets/images/vestido.png')} className="max-w-12 max-h-12 bg-white rounded-md p-2"></Image>
        </View>
      </View>
